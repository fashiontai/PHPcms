...
'cookie_pre' => 'gZULC_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'js_path' => 'http://www.aihj.ren/statics/js/', //CDN JS
'css_path' => 'http://www.aihj.ren/statics/css/', //CDN CSS
'img_path' => 'http://www.aihj.ren/statics/images/', //CDN img
'app_path' => 'http://www.aihj.ren/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'uUhpkK42Zbinac5TsuX9', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.aihj.ren/phpsso_server',	//接口地址
'phpsso_auth_key' => 'bMb8ECs4S6xanWdR5T4HviOEElR7fYAr', //加密密钥
